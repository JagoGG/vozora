...
import { DestructiveCommandDialog } from "./components/dictation/DestructiveCommandDialog";
...
function App() {
  ...
  // The technical error detail is logged to vozora.log on the Rust side
  ...
  // The payload is the backend error message (also logged to vozora.log).
  useEffect(() => {
