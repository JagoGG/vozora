...
export const ModelsSettings: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl w-full mx-auto space-y-4">
      ...
      {/* Backend errors (e.g. a failed model switch) were previously stored but
          never rendered, so activation failures looked like silent no-ops. */}
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                {/* Rescan local sources for models added outside Vozora */}
                <button
                  type="button"
