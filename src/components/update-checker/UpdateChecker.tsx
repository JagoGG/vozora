          ...
          <div className="bg-bg border border-border rounded-lg p-6 max-w-md w-full mx-4 space-y-4">
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button
                ...
                onClick={() => {
                  // NOTE: Vozora has no release/update infrastructure of its
                  // own yet (see docs/PACKAGING.md). This intentionally does
                  // NOT link to upstream Handy's releases, since those are
                  // Handy builds, not Vozora builds, and would be misleading
                  // here. Wire this to a real Vozora release feed before
                  // shipping auto-update.
