...
fn initialize_core_logic(app_handle: &AppHandle) {
    ...
    app_handle.manage(commands::dictation::PendingPasteState::default());
...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::vozora_keys::start_vozora_keys_recording,
            shortcut::vozora_keys::stop_vozora_keys_recording,
            commands::dictation::confirm_pending_paste,
            commands::dictation::cancel_pending_paste,
            commands::dictation::change_dictation_mode_setting,
            commands::dictation::change_app_profiles_setting,
    ...
    // Single-instance forwards CLI args to an already-running Vozora and exits.
